...
import Text from '../components/Pet/const/Text';
import { BLUR_HASH, PROFILE_MOCKS } from '../components/Pet/const/mockdata';
...
const Card = ({ profile, index }) => {
    return (
        ...
        >
            <Image
                style={styles.image}
                source={require('../assets/pomeranian2.png')}
    ...
    return (
        <View style={styles.container}>
            ...
            <Text style={styles.subtitle}>
                This is a list of your pet matches.
            </Text>
